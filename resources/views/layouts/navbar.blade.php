 ...
 <div class="header-navbar-shadow"></div>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
                        <span class="border border-secondary">
                         <li>
                        <!-- <img  src="{{URL::asset('/images/batman.JPG')}}"  height="70" width="200"> </li> -->
                        </span>
                ...
                <li class="nav-item mr-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-boxicons-template/index.html">
                        ...
                        <div class="brand-logo">
                            <svg class="logo" width="26px" height="26px" viewbox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <title>icon</title>
                                   <!-- <img  src="{{URL::asset('/images/four.PNG')}}"  height="70" width="150"> -->
                               
                                <title>icon</title> 
                                <!-- <li><img src="{{URL::asset('/images/four.PNG')}}"  height="100" width="250"></li> -->
                                <defs>
                        ...
                        <!-- <h2 class="brand-text mb-0">0000</h2> -->
                    </a></li>
     ...
     <!-- <div class="sidebar" id="sortable_row"> 
 
            <li class="border border-secondary">   
            <img src="{{URL::asset('/images/two.PNG')}}"  height="100" width="250"></li> 

             <li class="border border-secondary"><img src="{{URL::asset('/images/one.jpg')}}"  height="100" width="250"></li>
        
              <li class="border border-secondary"><img src="{{URL::asset('/images/three.PNG')}}"  height="100" width="250"></li>
            
            <li class="border border-secondary"><a href="https://www.training.mygov.bd/">
              <img src="{{URL::asset('/images/four.PNG')}}"  height="100" width="250"></a></li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
                <li class=" nav-item"><a href="index.html"><i class="bx bx-home-alt"></i><span class="menu-title text-truncate" data-i18n="Dashboard">Dashboard</span><span class="badge badge-light-danger badge-pill badge-round float-right mr-50 ml-auto">2</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a class="d-flex align-items-center" href="dashboard-analytics.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Analytics">Analytics</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" navigation-header text-truncate"><span data-i18n="Apps">Apps</span>
                </li>
                <li class=" nav-item"><a href="app-email.html"><i class="bx bx-envelope"></i><span class="menu-title text-truncate" data-i18n="Email">Email</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="bx bx-building"></i><span class="menu-title text-truncate" data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="../../../starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-1-column.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="1 column">1 column</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="../../../starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-2-columns.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="2 columns">2 columns</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="../../../starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-fixed-navbar.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Fixed navbar">Fixed navbar</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="../../../starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-fixed.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Fixed layout">Fixed layout</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="../../../starter-kit/ltr/vertical-menu-boxicons-template/sk-layout-static.html"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Static layout">Static layout</span></a>
                        </li>
                    </ul>
                </li>
